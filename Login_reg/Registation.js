...
const Registration = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.trim().length === 0 || username.trim().length === 0 || pass.trim().length === 0 || oneTimeLogin.trim().length === 0 || phone.trim().length !== 10) {
      setAlertMessage("Invalid input. Please check your details.");
      setShowAlert(true);
      valid = false;
    }
                ...
                <div className="col-6">
                  <center>
                    ...
                    <TextField
                      ...
                      color="secondary"
                      id="outlined-basic"
                      label="One time login password"
                      variant="outlined"
                      value={oneTimeLogin}
                      onChange={(event) => {
                        setOneTimeLogin(event.target.value);
                      }}
                      style={{ marginLeft: 150, width: 350 }}
                    />
                    <br></br> <br></br>
