...
//     // Uncomment the following block to enable API call
//     try {
...
//       const destination = `${value.dlat},${value.dlon}`; // Example destination
...
//         })
//         .then((data) => {
//           setpa( data.routes[0].overview_polyline);
...
//       </div>
//       <div className="py-5 ">
//         {payload&& <Map payload={payload}></Map>}
...
const Group = () => {
  ...
  return (
    <div className="p-5">
      ...
      <div className="py-5">
        {payload && <Map payload={payload} />} {/* Ensure Map re-renders */}
      </div>
    </div>
  );
};
